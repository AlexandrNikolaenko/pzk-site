...
export default function ScrollArrow({dir}: {dir: 1 | -1}) {
  ...
  return (
    <button onClick={handleScrollGallery} className={`${dir == -1 ? 'rotate-180 left-[104px]' : 'right-[104px]'} top-[203px] absolute w-[53px] aspect-square flex items-center justify-center rounded-full border border-white bg-background`}>
