...
export default function ScrollFeedbackArrow({
  dir,
  elemId,
}: {
  dir: 1 | -1;
  ...
  return (
    <button
      ...
      className={`${dir == -1 && "rotate-180"} w-[53px] aspect-square flex items-center justify-center rounded-full border border-white bg-background`}
    >
      <Image
